...
export const uploadProfilePicture = multerConfig('../uploads/img/admin') //c:/dev/IN6AM2025/AdoptionSystem/uploads/img/users/filename.png 



const multerConfigC = (destinationPath)=>{
    return multer(
        {
            storage: multer.diskStorage( //En donde se va a almacenar
                {
